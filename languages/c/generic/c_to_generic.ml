...
and expr e =
  ...
  | Defined (t, id) ->
      ...
      G.Call (G.Special (G.Defined, t) |> G.e, fb [ G.Arg e ]) |> G.e
  | Id v1 ->
      let v1 = name v1 in
  ...
  | Postfix (v1, (v2, v3)) ->
      ...
      G.Call
        (G.Special (G.IncrDecr (v2, G.Postfix), v3) |> G.e, fb [ G.Arg v1 ])
      |> G.e
  | Infix (v1, (v2, v3)) ->
      let v1 = expr v1 and v2 = fixOp v2 in
      G.Call
        (G.Special (G.IncrDecr (v2, G.Prefix), v3) |> G.e, fb [ G.Arg v1 ])
      |> G.e
  | Unary (v1, v2) ->
