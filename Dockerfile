# Build codemap (and many semgrep libs) with OCaml 4.14.2 via OPAM on Ubuntu.
...
# external deps of semgrep-libs itself
...
# and its Lang
#TODO: can't rm -rf because then can't find -ltree-sitter :( remove rpath?
# RUN rm -rf /semgrep
...
# Add external deps of codemap #alt: use opam-depext
